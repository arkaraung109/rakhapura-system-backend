...
public class SubjectController {
    ...
    public ResponseEntity<CustomHttpResponse> save(@Valid @RequestBody SubjectDto body, BindingResult bindingResult) {
    ...
    @RolesAllowed(AuthoritiesConstants.EXAM_ENTRY)
    public ResponseEntity<CustomHttpResponse> update(@Validated @RequestBody SubjectDto body, @PathVariable("id") Long id, BindingResult bindingResult) {
        if(!bindingResult.hasErrors()) {
