...
public class AcademicYearController {
    ...
    public ResponseEntity<CustomHttpResponse> save(@Valid @RequestBody AcademicYearDto body, BindingResult bindingResult) {
    ...
    @RolesAllowed(AuthoritiesConstants.EXAM_ENTRY)
    public ResponseEntity<CustomHttpResponse> update(@Validated @RequestBody AcademicYearDto body, @PathVariable("id") Long id, BindingResult bindingResult) {
        if(!bindingResult.hasErrors()) {
