...
public class RegionController {
    ...
    public ResponseEntity<CustomHttpResponse> save(@Valid @RequestBody RegionDto body, BindingResult bindingResult) {
    ...
    @RolesAllowed(AuthoritiesConstants.EXAM_ENTRY)
    public ResponseEntity<CustomHttpResponse> update(@Validated @RequestBody RegionDto body, @PathVariable("id") Long id, BindingResult bindingResult) {
        if(!bindingResult.hasErrors()) {
