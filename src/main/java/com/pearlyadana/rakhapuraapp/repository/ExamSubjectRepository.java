...
public interface ExamSubjectRepository extends JpaRepository<ExamSubject, Long> {
    ...
    @Query(value = joinQuery + " and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.academic_year_id=:academicYearId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.academic_year_id=:academicYearId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.exam_title_id=:examTitleId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.exam_title_id=:examTitleId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.exam_title_id=:examTitleId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.exam_title_id=:examTitleId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.exam_title_id=:examTitleId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.exam_title_id=:examTitleId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
    ...
    @Query(value = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.exam_title_id=:examTitleId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            countQuery = joinQuery + " and (e.academic_year_id=:academicYearId) and (e.exam_title_id=:examTitleId) and (e.subject_type_id=:subjectTypeId) and (es.subject_id=:subjectId)",
            nativeQuery = true)
